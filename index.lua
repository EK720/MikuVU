...
function getmiku()
	...
	if Network.isWifiEnabled() then
		Network.downloadFile("https://gelbooru.com/index.php?limit=1&page=dapi&s=post&q=index&json=1&tags=hatsune_miku+-furry+-animal_ears+sort:random+highres+"..ratingURL, dataFolder.."/post.json") 
